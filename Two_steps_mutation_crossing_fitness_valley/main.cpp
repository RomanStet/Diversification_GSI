...
int main()
{
    ...
    // Parameters:
    int Nt, NbGen, stepg, sampleS, it, p, mUsc, max_alleles, alleles_init, position_stream, state;
	...
	do	{
        ...
        openFileE();
                    ...
                    it, step, Usc, mUsc,
                    NbGen, deltai, stepg, sampleS, Un, position_stream, state);
        closeFileE();
                ...
                if(fopen(nameFileStart,"r")==NULL) {
                    ...
                    for (i = 0; i < itp; i++) {
						...
						res = recursion(numsimul, no, size_pop, a,
										Usc, mUsc, NbGen, delta, stepg, sampleS, Un,
